...
<div>
  ...
  <p>An estimated one-third to one-half of the nitrous oxide released into the atmosphere today is a result of human activities. The biggest culprit: the increase in agricultural lands and synthetic fertilizer use in agriculture, which has steadily increased in recent decades. And industrial farming—especially of annual crops like vegetables and grains—are especially to blame, as farmers tend to over-apply fertilizers to boost their yields.</p>
  <p>In essence, both synthetic and organic fertilizers increase the amount of nitrogen available to microbes in the soil, which turn it into nitrous oxide.</p>
  <p> Experts say the key to reducing agricultural emissions of nitrous oxide is using fertilizer more efficiently. This means figuring out the right amount to use and the right time to apply it.</p>
  <p>It could help the world achieve multiple goals related to environmental and social sustainability.</p>
