        ...
        >
          ...
          <div className="social-icons">
            <IconContext.Provider value={{ className: "social-icons" }}>
              ...
              <a
                href="https://www.instagram.com/ilaria.nuzzaco/"
                rel="noreferrer"
                target="_blank"
                className="social-icon"
              >
              ...
              <a
                href="https://it.linkedin.com/in/ilaria-nuzzaco-front-end-developer"
                rel="noopener"
                target="_blank"
                className="social-icon"
              >
        ...
        <CDBSidebarContent className="sidebar-container">
          <CDBSidebarMenu>
            ...
            <NavLink exact to="/temperature" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="temperature-high">
                Temperature
              </CDBSidebarMenuItem>
            </NavLink>
